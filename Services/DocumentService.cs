...
public class DocumentService : IDocumentService
{
    ...
    {
        string sql = @"INSERT INTO Document(FileName,FileLocation,Description,UserId,DisplayOrder,Date,CategoryId)
                        OUTPUT INSERTED.Id
                        VALUES (@FileName,@FileLocation,@Description,@UserId,@DisplayOrder,@Date,@CategoryId)";
    ...
    {
        string sql = @"UPDATE Document SET FileName=@FileName, FileLocation=@FileLocation, Description=@Description, UserId=@UserId,DisplayOrder=@DisplayOrder, Date=@Date, CategoryId=@CategoryId
                       WHERE Id=@Id";
